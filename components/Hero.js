        ...
        <section className="grid grid-cols-1 md:grid-cols-5 gap-2 h-full py-4 md:p-0 mb-20 font-medium relative">
            <div className="col-span-3 flex flex-col justify-center p-4 md:p-0 translate-y-24">
                ...
                <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">
                    <button className="flex items-center gap-2 bg-black text-white px-4 py-2 rounded">Get Started <span><Image src={RightArrow} /></span></button>
            ...
            <div className="col-span-2 flex justify-center items-center relative">
                <Image src={Iphone2} className="absolute min-w-60 -rotate-[16deg] z-30 right-10 -top-14" />
